...
var $author$project$Main$NotLogged = {$: 'NotLogged'};
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{color: 'red', colorValue: 0, currentMessage: '', messages: _List_Nil, password: '', session: '', state: $author$project$Main$NotLogged, username: ''},
...
var $author$project$Main$subscriptions = function (model) {
	...
	if (_v0.$ === 'NotLogged') {
		...
		return A2($elm$time$Time$every, 3333, $author$project$Main$GetMessages);
	}
};
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'color',
							$elm$json$Json$Encode$string(m.color)),
							_Utils_Tuple2(
							'text',
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							color: 'hsl(' + ($elm$core$String$fromFloat(f) + ', 100%, 50%)'),
							colorValue: f
						}),
					$elm$core$Platform$Cmd$none);
		}
...
var $author$project$Main$colorDisplay = function (m) {
	return $aforemny$material_components_web_elm$Material$Slider$slider(
		A2(
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$elm$core$Maybe$Just(
						A2(
							$aforemny$material_components_web_elm$Material$TextField$icon,
							_List_Nil,
...
var $author$project$Main$viewMessageList = function (messages) {
	...
	var getHead = function (l) {
		var _v1 = $elm$core$List$head(l);
		if (_v1.$ === 'Just') {
			var m = _v1.a;
			return m;
		} else {
			return A4($author$project$Main$Message, '', '', '', 0);
		}
	};
	var _v0 = $elm$core$List$isEmpty(messages);
	if (_v0) {
		return A2(
			$elm$html$Html$h3,
			_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$style, 'color', model.color)
									]),
								_List_fromArray(
									[
...
var $author$project$Main$loginForm = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Events$onSubmit($author$project$Main$AttemptLogin),
		...
		_List_fromArray(
			[
				...
				A2(
					$aforemny$material_components_web_elm$Material$TextField$setLeadingIcon,
					$elm$core$Maybe$Just(
						A2($aforemny$material_components_web_elm$Material$TextField$icon, _List_Nil, 'face')),
					A2(
						$aforemny$material_components_web_elm$Material$TextField$setOnInput,
						...
						A2(
							...
							A2(
								$aforemny$material_components_web_elm$Material$TextField$setValue,
								$elm$core$Maybe$Just(model.username),
								A2(
									$aforemny$material_components_web_elm$Material$TextField$setPlaceholder,
				...
				A2(
					$aforemny$material_components_web_elm$Material$TextField$setLeadingIcon,
					$elm$core$Maybe$Just(
						A2($aforemny$material_components_web_elm$Material$TextField$icon, _List_Nil, 'vpn_key')),
					A2(
						$aforemny$material_components_web_elm$Material$TextField$setOnInput,
						...
						A2(
							...
							A2(
								$aforemny$material_components_web_elm$Material$TextField$setValue,
								$elm$core$Maybe$Just(model.password),
								A2(
									$aforemny$material_components_web_elm$Material$TextField$setPlaceholder,
...
var $author$project$Main$view = function (model) {
	var _v0 = model.state;
	if (_v0.$ === 'NotLogged') {
		return $author$project$Main$loginForm(model);
	} else {
