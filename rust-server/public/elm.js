...
var $author$project$Main$NotLogged = function (a) {
...
var $author$project$Main$LoginInfo = F3(
	function (sessionId, username, status) {
		return {sessionId: sessionId, status: status, username: username};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $elm$json$Json$Decode$map3 = _Json_map3;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$loginDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$LoginInfo,
...
var $author$project$Main$attemptAutoLogin = $elm$http$Http$riskyRequest(
	{
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'authType',
						$elm$json$Json$Encode$string('autologin')),
						_Utils_Tuple2(
						'username',
...
var $author$project$Main$first3 = function (_v0) {
	var a = _v0.a;
	return a;
};
...
var $tesk9$palette$Internal$Hex$fromHexSymbol = function (m) {
	var decValues = $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2(
				_Utils_chr('0'),
...
var $tesk9$palette$Internal$Hex$hexWithAlpha = F4(
	function (rs, gs, bs, aa) {
		var fromHex = function (_v0) {
			var a = _v0.a;
			var b = _v0.b;
			return (a * 16) + b;
		};
		return {
			alpha: A2(
				...
				$tesk9$palette$Internal$Opacity$opaque,
				A2(
					$elm$core$Maybe$map,
					$tesk9$palette$Internal$Opacity$custom,
					A2($elm$core$Maybe$map, fromHex, aa))),
			blue: fromHex(bs),
			green: fromHex(gs),
			red: fromHex(rs)
		};
...
var $tesk9$palette$Internal$Hex$fromString = function (colorString) {
	var colorList = A2(
		$elm$core$List$filterMap,
		$tesk9$palette$Internal$Hex$fromHexSymbol,
		$elm$core$String$toList(colorString));
	_v0$4:
	while (true) {
		if ((colorList.b && colorList.b.b) && colorList.b.b.b) {
			if (colorList.b.b.b.b) {
				if (colorList.b.b.b.b.b) {
					if (colorList.b.b.b.b.b.b) {
						if (colorList.b.b.b.b.b.b.b) {
							if (colorList.b.b.b.b.b.b.b.b && (!colorList.b.b.b.b.b.b.b.b.b)) {
								var r1 = colorList.a;
								var _v1 = colorList.b;
								var r0 = _v1.a;
								var _v2 = _v1.b;
								...
								return $elm$core$Maybe$Just(
									A4(
										$tesk9$palette$Internal$Hex$hexWithAlpha,
										_Utils_Tuple2(r1, r0),
										_Utils_Tuple2(g1, g0),
										_Utils_Tuple2(b1, b0),
										$elm$core$Maybe$Just(
...
var $tesk9$palette$SolidColor$fromHex = function (colorString) {
	var _v0 = $tesk9$palette$Internal$Hex$fromString(colorString);
	if (_v0.$ === 'Just') {
		var red = _v0.a.red;
		var green = _v0.a.green;
		var blue = _v0.a.blue;
		return $elm$core$Result$Ok(
			$tesk9$palette$SolidColor$fromRGB(
				_Utils_Tuple3(red, green, blue)));
	} else {
		return $elm$core$Result$Err('fromHex could not convert ' + (colorString + ' to a Color.'));
	}
};
...
var $tesk9$palette$SolidColor$toHSL = function (_v0) {
	var color = _v0.a;
...
var $author$project$Main$hexToHue = function (hex) {
	var _v0 = $tesk9$palette$SolidColor$fromHex(hex);
	if (_v0.$ === 'Ok') {
		var val = _v0.a;
		return $author$project$Main$first3(
			$tesk9$palette$SolidColor$toHSL(val));
	} else {
		return 0;
	}
};
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{
			colorValue: $author$project$Main$hexToHue(flags),
			currentMessage: '',
			messages: _List_Nil,
			password: '',
			password_confirm: '',
			session: '',
			state: $author$project$Main$NotLogged($author$project$Main$Login),
			username: ''
		},
		$author$project$Main$attemptAutoLogin);
};
var $author$project$Main$GetMessages = function (a) {
	return {$: 'GetMessages', a: a};
};
...
var $author$project$Main$subscriptions = function (model) {
	var _v0 = model.state;
	if (_v0.$ === 'Logged') {
		return A2($elm$time$Time$every, 333, $author$project$Main$GetMessages);
	} else {
		return $elm$core$Platform$Sub$none;
	}
};
var $author$project$Main$Logged = {$: 'Logged'};
var $author$project$Main$Register = {$: 'Register'};
var $author$project$Main$GotMessages = function (a) {
...
var $author$project$Main$Message = F4(
	function (sender, color, text, timestamp) {
		return {color: color, sender: sender, text: text, timestamp: timestamp};
	});
var $author$project$Main$andMap = $elm$json$Json$Decode$map2($elm$core$Basics$apR);
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$messageDecoder = $elm$json$Json$Decode$list(
	A2(
...
var $author$project$Main$getMessages = function (model) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Main$GotMessages, $author$project$Main$messageDecoder),
			url: '/message'
		});
};
...
var $tesk9$palette$SolidColor$fromHSL = function (_v0) {
	var hue = _v0.a;
...
var $tesk9$palette$SolidColor$toRGB = function (_v0) {
	var color = _v0.a;
...
var $tesk9$palette$SolidColor$toHex = function (color) {
	var _v0 = $tesk9$palette$SolidColor$toRGB(color);
	var red = _v0.a;
	var green = _v0.b;
	var blue = _v0.c;
...
var $author$project$Main$hueToHex = function (hue) {
	return $tesk9$palette$SolidColor$toHex(
		$tesk9$palette$SolidColor$fromHSL(
			_Utils_Tuple3(hue, 100, 50)));
};
...
var $author$project$Main$postLogin = function (model) {
...
var $author$project$Main$postRegister = function (m) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'username',
							$elm$json$Json$Encode$string(m.username)),
							_Utils_Tuple2(
							'password',
							$elm$json$Json$Encode$string(m.password)),
							_Utils_Tuple2(
							'password2',
							$elm$json$Json$Encode$string(m.password_confirm))
						]))),
			expect: A2($elm$http$Http$expectJson, $author$project$Main$GotLogin, $author$project$Main$loginDecoder),
			url: '/register'
		});
...
var $author$project$Main$sendMessage = function (m) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							'color',
							$elm$json$Json$Encode$string(
								$author$project$Main$hueToHex(m.colorValue))),
							_Utils_Tuple2(
							'text',
							$elm$json$Json$Encode$string(m.currentMessage))
						]))),
			expect: $elm$http$Http$expectString($author$project$Main$MessageSent),
			url: '/message'
		});
};
	...
	function (msg, model) {
		switch (msg.$) {
			case 'AttemptLogin':
				return _Utils_Tuple2(
					model,
					$author$project$Main$postLogin(model));
			case 'AttemptRegister':
				return _Utils_Tuple2(
					model,
					$author$project$Main$postRegister(model));
			case 'GotLogin':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var info = result.a;
					...
					if (_v2 === 1) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{session: info.sessionId, state: $author$project$Main$Logged, username: info.username}),
							$author$project$Main$getMessages(model));
					} else {
			...
			case 'SendMessage':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentMessage: ''}),
					$author$project$Main$sendMessage(model));
			case 'MessageSent':
				var result = msg.a;
				if (result.$ === 'Ok') {
					return _Utils_Tuple2(
			...
			case 'ColorChanged':
				...
				return _Utils_Tuple2(
					...
					$author$project$Main$setStorage(
						_Utils_Tuple2(
							'color',
							$author$project$Main$hueToHex(model.colorValue))));
			case 'ShowLoginForm':
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							password: '',
							state: $author$project$Main$NotLogged($author$project$Main$Register)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$calcUsernameBackgroundWidth = function (usr) {
	return $elm$core$String$fromInt(
		$elm$core$String$length('Username: ' + usr) + 5) + 'em';
};
...
var $author$project$Main$ColorChanged = function (a) {
	return {$: 'ColorChanged', a: a};
};
var $aforemny$material_components_web_elm$Material$Slider$Config = function (a) {
	return {$: 'Config', a: a};
};
var $aforemny$material_components_web_elm$Material$Slider$config = $aforemny$material_components_web_elm$Material$Slider$Config(
	{additionalAttributes: _List_Nil, disabled: false, discrete: false, displayMarkers: false, max: $elm$core$Maybe$Nothing, min: $elm$core$Maybe$Nothing, onInput: $elm$core$Maybe$Nothing, step: $elm$core$Maybe$Nothing, value: $elm$core$Maybe$Nothing});
var $elm$html$Html$div = _VirtualDom_node('div');
var $aforemny$material_components_web_elm$Material$Slider$setAttributes = F2(
	function (additionalAttributes, _v0) {
		var config_ = _v0.a;
		return $aforemny$material_components_web_elm$Material$Slider$Config(
			_Utils_update(
				config_,
				{additionalAttributes: additionalAttributes}));
	});
var $aforemny$material_components_web_elm$Material$Slider$setMax = F2(
	function (max, _v0) {
		var config_ = _v0.a;
		return $aforemny$material_components_web_elm$Material$Slider$Config(
			_Utils_update(
...
var $aforemny$material_components_web_elm$Material$Slider$setOnInput = F2(
...
var $aforemny$material_components_web_elm$Material$Slider$setValue = F2(
	function (value, _v0) {
		var config_ = _v0.a;
		return $aforemny$material_components_web_elm$Material$Slider$Config(
			_Utils_update(
...
var $aforemny$material_components_web_elm$Material$Slider$ariaValueMaxAttr = function (_v0) {
	var max = _v0.a.max;
	return A2(
		$elm$core$Maybe$map,
		A2(
...
var $aforemny$material_components_web_elm$Material$Slider$ariaValueMinAttr = function (_v0) {
	var min = _v0.a.min;
	return A2(
		$elm$core$Maybe$map,
		A2(
...
var $aforemny$material_components_web_elm$Material$Slider$ariaValuenowAttr = function (_v0) {
...
var $aforemny$material_components_web_elm$Material$Slider$changeHandler = function (_v0) {
...
var $aforemny$material_components_web_elm$Material$Slider$disabledProp = function (_v0) {
...
var $aforemny$material_components_web_elm$Material$Slider$discreteCs = function (_v0) {
...
var $aforemny$material_components_web_elm$Material$Slider$displayCss = $elm$core$Maybe$Just(
	A2($elm$html$Html$Attributes$style, 'display', 'block'));
var $aforemny$material_components_web_elm$Material$Slider$displayMarkersCs = function (_v0) {
	var discrete = _v0.a.discrete;
...
var $aforemny$material_components_web_elm$Material$Slider$maxProp = function (_v0) {
	var max = _v0.a.max;
	return A2(
		$elm$core$Maybe$map,
		A2(
...
var $aforemny$material_components_web_elm$Material$Slider$minProp = function (_v0) {
	var min = _v0.a.min;
	return A2(
		$elm$core$Maybe$map,
		A2(
...
var $aforemny$material_components_web_elm$Material$Slider$rootCs = $elm$core$Maybe$Just(
	$elm$html$Html$Attributes$class('mdc-slider'));
var $aforemny$material_components_web_elm$Material$Slider$sliderRoleAttr = $elm$core$Maybe$Just(
	A2($elm$html$Html$Attributes$attribute, 'role', 'slider'));
var $aforemny$material_components_web_elm$Material$Slider$stepProp = function (_v0) {
	var step = _v0.a.step;
	return A2(
		$elm$core$Maybe$map,
		A2(
...
var $aforemny$material_components_web_elm$Material$Slider$tabIndexProp = $elm$core$Maybe$Just(
	$elm$html$Html$Attributes$tabindex(0));
var $aforemny$material_components_web_elm$Material$Slider$focusRingElt = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_Nil);
var $aforemny$material_components_web_elm$Material$Slider$pinValueMarkerElt = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_Nil);
var $aforemny$material_components_web_elm$Material$Slider$pinElt = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[$aforemny$material_components_web_elm$Material$Slider$pinValueMarkerElt]));
...
var $aforemny$material_components_web_elm$Material$Slider$thumbElt = A2(
	$elm$svg$Svg$svg,
	_List_fromArray(
		[
...
var $aforemny$material_components_web_elm$Material$Slider$thumbContainerElt = function (_v0) {
	var discrete = _v0.a.discrete;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
		...
		discrete ? _List_fromArray(
			[$aforemny$material_components_web_elm$Material$Slider$pinElt, $aforemny$material_components_web_elm$Material$Slider$thumbElt, $aforemny$material_components_web_elm$Material$Slider$focusRingElt]) : _List_fromArray(
			[$aforemny$material_components_web_elm$Material$Slider$thumbElt, $aforemny$material_components_web_elm$Material$Slider$focusRingElt]));
};
var $aforemny$material_components_web_elm$Material$Slider$trackElt = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_Nil);
var $aforemny$material_components_web_elm$Material$Slider$trackMarkerContainerElt = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_Nil);
var $aforemny$material_components_web_elm$Material$Slider$trackContainerElt = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[$aforemny$material_components_web_elm$Material$Slider$trackElt, $aforemny$material_components_web_elm$Material$Slider$trackMarkerContainerElt]));
var $aforemny$material_components_web_elm$Material$Slider$valueProp = function (_v0) {
	var value = _v0.a.value;
	return A2(
		$elm$core$Maybe$map,
		A2(
...
var $aforemny$material_components_web_elm$Material$Slider$slider = function (config_) {
	...
	return A3(
		...
		_Utils_ap(
			A2(
				...
				_List_fromArray(
					[
						$aforemny$material_components_web_elm$Material$Slider$rootCs,
						$aforemny$material_components_web_elm$Material$Slider$displayCss,
						$aforemny$material_components_web_elm$Material$Slider$discreteCs(config_),
						$aforemny$material_components_web_elm$Material$Slider$displayMarkersCs(config_),
						$aforemny$material_components_web_elm$Material$Slider$tabIndexProp,
						$aforemny$material_components_web_elm$Material$Slider$sliderRoleAttr,
						$aforemny$material_components_web_elm$Material$Slider$valueProp(config_),
						$aforemny$material_components_web_elm$Material$Slider$minProp(config_),
						$aforemny$material_components_web_elm$Material$Slider$maxProp(config_),
						$aforemny$material_components_web_elm$Material$Slider$stepProp(config_),
						$aforemny$material_components_web_elm$Material$Slider$disabledProp(config_),
						$aforemny$material_components_web_elm$Material$Slider$ariaValueMinAttr(config_),
						$aforemny$material_components_web_elm$Material$Slider$ariaValueMaxAttr(config_),
						$aforemny$material_components_web_elm$Material$Slider$ariaValuenowAttr(config_),
						$aforemny$material_components_web_elm$Material$Slider$changeHandler(config_)
					])),
			additionalAttributes),
		_List_fromArray(
			[
				$aforemny$material_components_web_elm$Material$Slider$trackContainerElt,
				$aforemny$material_components_web_elm$Material$Slider$thumbContainerElt(config_)
			]));
};
var $author$project$Main$colorDisplay = function (m) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$aforemny$material_components_web_elm$Material$Slider$slider(
				A2(
					$aforemny$material_components_web_elm$Material$Slider$setOnInput,
					$author$project$Main$ColorChanged,
					A2(
						$aforemny$material_components_web_elm$Material$Slider$setMax,
						$elm$core$Maybe$Just(360),
						A2(
							$aforemny$material_components_web_elm$Material$Slider$setValue,
							$elm$core$Maybe$Just(m.colorValue),
							A2($aforemny$material_components_web_elm$Material$Slider$setAttributes, _List_Nil, $aforemny$material_components_web_elm$Material$Slider$config)))))
			]));
};
...
var $author$project$Main$determineIcon = function (msg) {
	var _v0 = $elm$core$String$length(msg);
	if (!_v0) {
...
var $aforemny$material_components_web_elm$Material$TextField$config = $aforemny$material_components_web_elm$Material$TextField$Config(
	{additionalAttributes: _List_Nil, disabled: false, fullwidth: false, label: $elm$core$Maybe$Nothing, leadingIcon: $elm$core$Maybe$Nothing, max: $elm$core$Maybe$Nothing, maxLength: $elm$core$Maybe$Nothing, min: $elm$core$Maybe$Nothing, minLength: $elm$core$Maybe$Nothing, onChange: $elm$core$Maybe$Nothing, onInput: $elm$core$Maybe$Nothing, pattern: $elm$core$Maybe$Nothing, placeholder: $elm$core$Maybe$Nothing, required: false, step: $elm$core$Maybe$Nothing, trailingIcon: $elm$core$Maybe$Nothing, type_: $elm$core$Maybe$Nothing, valid: true, value: $elm$core$Maybe$Nothing});
...
var $aforemny$material_components_web_elm$Material$TextField$trailingIconElt = function (_v0) {
	...
	if (trailingIcon.$ === 'Nothing') {
		return _List_Nil;
	} else {
		var html = trailingIcon.a.a;
		return _List_fromArray(
			[html]);
	}
};
...
var $aforemny$material_components_web_elm$Material$TextField$Icon = function (a) {
	return {$: 'Icon', a: a};
};
...
var $aforemny$material_components_web_elm$Material$TextField$icon = F2(
	function (additionalAttributes, iconName) {
		return $aforemny$material_components_web_elm$Material$TextField$Icon(
			A2(
...
var $author$project$Main$materialTextField = F7(
	function (str, setType, placeholder, arr, icon, isValid, updateFunction) {
		return $aforemny$material_components_web_elm$Material$TextField$filled(
			A2(
				...
				$elm$core$Maybe$Just(
					A2($aforemny$material_components_web_elm$Material$TextField$icon, _List_Nil, icon)),
				A2(
										...
										_Utils_ap(
											_List_fromArray(
												[
													...
													$elm$html$Html$Attributes$class('material-text-field')
												]),
											arr),
										A2(
											$aforemny$material_components_web_elm$Material$TextField$setType,
											$elm$core$Maybe$Just(setType),
...
var $author$project$Main$sendMessageForm = function (model) {
	return A2(
		$elm$html$Html$form,
		_List_fromArray(
			[
				$elm$html$Html$Events$onSubmit($author$project$Main$SendMessage),
				$elm$html$Html$Attributes$class('message-form')
			]),
		_List_fromArray(
			[
				A7(
				$author$project$Main$materialTextField,
				model.currentMessage,
				'text',
				'Type here...',
				_List_Nil,
				$author$project$Main$determineIcon(model.currentMessage),
				!$elm$core$String$isEmpty(model.currentMessage),
...
var $author$project$Main$styles = _List_fromArray(
	[
		_Utils_Tuple2('**', $elm$html$Html$b),
		_Utils_Tuple2('*', $elm$html$Html$i),
		_Utils_Tuple2('__', $elm$html$Html$u),
		_Utils_Tuple2('~~', $elm$html$Html$s)
	]);
var $author$project$Main$createStylelist = function (str) {
	var getHead = function (list) {
	...
	return A2(
		...
		function (_v1) {
			...
			var b = _v1.b;
			return getHead(
				A2($elm$core$String$indexes, _char, str));
		},
		A2(
			...
			function (_v0) {
				...
				return $elm$core$List$length(
					A2($elm$core$String$indexes, _char, str)) >= 2;
			},
			$author$project$Main$styles));
};
var $author$project$Main$formatMessage = function (str) {
	var _v0 = $author$project$Main$createStylelist(str);
	if (!_v0.b) {
		return _List_fromArray(
			[
				$elm$html$Html$text(str)
		...
		var chars = _v1.a;
		var tag = _v1.b;
		var restoflist = _v0.b;
		var _v2 = A2($elm$core$String$split, chars, str);
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							tag,
							_List_Nil,
							$author$project$Main$formatMessage(b))
						]),
					$author$project$Main$formatMessage(
						A2(
							$elm$core$String$join,
							chars,
...
var $aforemny$material_components_web_elm$Material$Typography$headline3 = $elm$html$Html$Attributes$class('mdc-typography--headline3');
...
var $aforemny$material_components_web_elm$Material$List$setAvatarList = F2(
...
var $aforemny$material_components_web_elm$Material$List$setNonInteractive = F2(
	function (nonInteractive, _v0) {
		var config_ = _v0.a;
		return $aforemny$material_components_web_elm$Material$List$Config(
			_Utils_update(
				config_,
...
var $aforemny$material_components_web_elm$Material$Elevation$z16 = $aforemny$material_components_web_elm$Material$Elevation$z(16);
var $aforemny$material_components_web_elm$Material$Elevation$z24 = $aforemny$material_components_web_elm$Material$Elevation$z(24);
var $author$project$Main$viewMessageList = function (messages) {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[$aforemny$material_components_web_elm$Material$Elevation$z16]),
					_List_fromArray(
						[
							svgCircle(m.color)
						])),
					...
					_List_Nil,
					{
						primary: _List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('message-sender'),
										A2($elm$html$Html$Attributes$style, 'color', m.color)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(m.sender)
									]))
							]),
						secondary: _List_fromArray(
							[
								...
								$author$project$Main$formatMessage(m.text))
							])
					})
				]));
	};
	var _v0 = $elm$core$List$head(messages);
	if (_v0.$ === 'Nothing') {
		return A2(
			$elm$html$Html$h3,
			_List_fromArray(
				[$aforemny$material_components_web_elm$Material$Typography$headline3]),
			_List_fromArray(
				[
					$elm$html$Html$text('Looks like there are no messages yet!')
				]));
	} else {
		var head = _v0.a;
		return A3(
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('message-list-container'),
						$aforemny$material_components_web_elm$Material$Elevation$z24
					]),
				A2(
					$aforemny$material_components_web_elm$Material$List$setAvatarList,
					true,
					A2(
						$aforemny$material_components_web_elm$Material$List$setTwoLine,
						true,
						A2($aforemny$material_components_web_elm$Material$List$setNonInteractive, false, $aforemny$material_components_web_elm$Material$List$config)))),
			toList(head),
			A2(
				$elm$core$List$map,
				toList,
				A2($elm$core$List$drop, 1, messages)));
	}
};
var $author$project$Main$chatForm = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('username-display'),
						A2(
						$elm$html$Html$Attributes$style,
						'width',
						$author$project$Main$calcUsernameBackgroundWidth(model.username))
					]),
				_List_fromArray(
					[
						A2(
				...
				$author$project$Main$colorDisplay(model),
				$author$project$Main$viewMessageList(model.messages),
				$author$project$Main$sendMessageForm(model)
			]));
};
var $author$project$Main$AttemptLogin = {$: 'AttemptLogin'};
var $author$project$Main$AttemptRegister = {$: 'AttemptRegister'};
var $author$project$Main$ShowLoginForm = {$: 'ShowLoginForm'};
var $author$project$Main$ShowRegisterForm = {$: 'ShowRegisterForm'};
var $author$project$Main$UpdatePassword = function (a) {
	return {$: 'UpdatePassword', a: a};
};
var $author$project$Main$UpdatePasswordConfirm = function (a) {
	return {$: 'UpdatePasswordConfirm', a: a};
};
...
var $author$project$Main$hasChars = function (str) {
...
var $author$project$Main$displayForm = F2(
			...
			function (bool, el) {
				if (bool) {
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('confirm-password tobehidden')
							]),
						_List_fromArray(
							[el]));
				} else {
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('confirm-password')
							]),
						_List_fromArray(
							[el]));
				}
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(either, $author$project$Main$AttemptLogin, $author$project$Main$AttemptRegister)),
			...
			_List_fromArray(
				[
					...
					_List_Nil,
					'face',
					$author$project$Main$hasChars(model.username),
					$author$project$Main$UpdateUsername),
					A7(
					$author$project$Main$materialTextField,
					model.password,
					'password',
					...
					_List_Nil,
					'vpn_key',
					$author$project$Main$hasChars(model.password),
					$author$project$Main$UpdatePassword),
					A2(
					hide,
					A2(either, true, false),
					A7(
						$author$project$Main$materialTextField,
						...
						'vpn_key',
						!$elm$core$String$isEmpty(model.password_confirm),
						$author$project$Main$UpdatePasswordConfirm)),
					A2(
					$elm$html$Html$span,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('changing-text')
						]),
					_List_fromArray(
						[
							A2(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								A2(either, $author$project$Main$ShowRegisterForm, $author$project$Main$ShowLoginForm),
								A2(
									$aforemny$material_components_web_elm$Material$Button$setAttributes,
									_List_fromArray(
										[
									...
									$aforemny$material_components_web_elm$Material$Button$config)),
							A2(either, 'GO TO REGISTER', 'GO TO LOGIN'))
						]))
				]));
	});
var $author$project$Main$view = function (model) {
	...
	if (_v0.$ === 'NotLogged') {
		var formType = _v0.a;
		return A2($author$project$Main$displayForm, model, formType);
	} else {
		return $author$project$Main$chatForm(model);
	}
};
